 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Fn3  |  FN  | GUI  | Alt  |N(Muhen)|Space|Bksp |Enter |Henkan| Left | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT( \
  ...
  FN3,     FN,     KC_LGUI, KC_LALT,_N(KC_MHEN),KC_SPC, KC_BSPC, KC_ENT,  KC_HENK, KC_LEFT, KC_DOWN, KC_RGHT \
),

/* Numpad( for the left hand)
 * ,-----------------------------------------------------------------------------------.
 * |      |      | Num/ | Num* | Num- |      |      |      \      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      | Num7 | Num8 | Num9 | Num- |      |      |      \      |      |      |      |
...
[_NUMPAD] = LAYOUT( \
  ...
  _______, KC_P7,   KC_P8,   KC_P9,   KC_PMNS, _______,  _______, _______, _______, _______, _______, _______, \
  _______, KC_P4,   KC_P5,   KC_P6,   KC_PPLS, _______,  _______, _______, _______, _______, _______, _______, \
 ...
 * | Shift|   Z  |   X  |   C  |   V  |   B  |   N  |   M  | ,or< | .or> |  UP  | /or? |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Fn3  |  FN  | GUI  | Alt  |G(Muhen)|Space| Bksp |Enter |Henkan| Left | Down |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_GAMING] = LAYOUT( \
  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS, \
  ...
  KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_UP,   KC_SLSH, \
  FN3,     FN,      KC_LGUI, KC_LALT,_G(KC_MHEN),KC_SPC, KC_BSPC, KC_ENT,  KC_HENK, KC_LEFT, KC_DOWN, KC_RGHT \
),
 ...
 * |      |   6  |   7  |   8  |   9  |   0  |      |      \      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |PG UP |  UP  |PG DOWN|  O  |   P  |      |      \      |      |      |      |
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      | Left | Down |Right |   L  | ENTER|      |      \      |      |      |      |
 * |------+------+------+------+------+------|------+------+------+------+------+------|
 * |      | HOME |   M  | END  | .or> | DEL  |      |      \      |      |      |      |
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * |      |      |      |      |      | BSPC |      |      \      |      |      |      |
...
[_GAMING_FN] = LAYOUT( \
  ...
  _______, KC_PGUP, KC_UP,   KC_PGDN, KC_O,    KC_P,    _______, _______,  _______, _______, _______, _______, \
  _______, KC_LEFT, KC_DOWN, KC_RGHT, KC_L,    KC_ENT,  _______, _______,  _______, _______, _______, _______, \
  _______, KC_HOME, KC_M,    KC_END,  KC_DOT,  KC_DEL,  _______, _______,  _______, _______, _______, _______,\
...
[_LOWER] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______, KC_BSPC, KC_ENT,  KC_HENK, _______, _______, _______, \
...
[_RAISE] = LAYOUT( \
  ...
  _______, _______, KC_LGUI, KC_LALT, KC_MHEN, KC_SPC,  _______, _______, JP_LBRC, JP_RBRC, JP_COLN, JP_QUOT, \
 ...
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * | F11  |      |PG UP |      |      |      |SONG 1|SONG 2|SONG 3|SONG 4|SONG 5|LED HSV|
 * |------+------+------+------+------+-------------+------+------+------+------+------|
 * |      |HOME  |PG DOWN| END |      |      |      |      |      |      |      |LED TST|
 * |------+------+------+------+------+------|------+------+------+------+------+------|
...
[_FN3] = LAYOUT( \
  ...
  KC_F11 , _______, KC_PGUP, _______, _______, _______, SONG1,   SONG2,   SONG3,   SONG4,   SONG5,   RGB_M_G, \
  _______, KC_HOME, KC_PGDN, KC_END , _______, _______, _______, _______, _______, _______, _______, RGB_M_T, \
  _______, _______, _______, _______, _______, _______, RGB_M_SN, RGB_M_K, RGB_M_B, RGB_SAD, RGB_VAI, RGB_SAI, \
  _______, _______, _______, _______, _______, _______, RGB_TOG, _______, _______, RGB_HUD, RGB_VAD, RGB_HUI \
),
