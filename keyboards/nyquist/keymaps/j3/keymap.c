...
[_FN3] = LAYOUT( \
  ...
  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  RGB_HUD, RGB_HUI, RGB_SAD, RGB_SAI, RGB_VAD, RGB_VAI, _______, _______, _______, _______, _______, _______, \
  _______, RGB_MOD, RGB_M_K, RGB_M_B, RGB_M_P, RGB_M_R, RGB_M_SW,RGB_M_SN,RGB_M_X, RGB_M_G, KC_MS_U, _______, \
  _______, _______, RGB_TOG, _______, KC_BTN2, KC_BTN1, _______, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R \
),
